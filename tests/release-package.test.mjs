...
test("release workflow packages runtime geography, cartography and operational assets", () => {
...
test("Foundry and package versions agree on the v0.6.0 release archive", () => {
  ...
  assert.match(manifest.download, /v0\.6\.0\/orphaned-sun-cluster-map-v0\.6\.0\.zip$/);
});
