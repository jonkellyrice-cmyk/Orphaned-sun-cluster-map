...
export const FACTION_TERRITORIES = Object.freeze([
  ...
  Object.freeze({
    ...
    footprint: Object.freeze([
      ...
      Object.freeze({ x: -4.7, y: 4.5 }),
      Object.freeze({ x: -3.3, y: 4.4 }),
      Object.freeze({ x: -2.5, y: 3.4 }),
      Object.freeze({ x: -3.2, y: 2.4 }),
      Object.freeze({ x: -2.6, y: 1.5 }),
      Object.freeze({ x: -2.9, y: 0.2 }),
      Object.freeze({ x: -2.6, y: -1.0 }),
      Object.freeze({ x: -2.9, y: -2.4 }),
      Object.freeze({ x: -2.4, y: -3.6 }),
